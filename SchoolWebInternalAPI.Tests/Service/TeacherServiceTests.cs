...
namespace SchoolWebInternalAPI.Application.Services
{
    public class TeacherService : ITeacherService
    {
        ...
        // GET ALL
        // --------------------------------------------------------------
        public async Task<ApiResponse<List<TeacherResponseDto>>> GetAllAsync(
        ...
        // GET BY ID
        // --------------------------------------------------------------
        public async Task<ApiResponse<TeacherResponseDto>> GetByIdAsync(
            int id,
            CancellationToken cancellationToken = default)
        {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            // Apply update DTO fields onto the entity
